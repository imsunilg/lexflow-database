...
legal.practiceareas — object folder for the `PracticeAreas` table(s), part of the Legal schema (matters/court cases). See PRD §18, Module 4 (Matter Management) and Module 5 (Court Case Management).
