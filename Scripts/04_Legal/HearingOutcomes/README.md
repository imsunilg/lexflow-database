...
legal.hearingoutcomes — object folder for the `HearingOutcomes` table(s), part of the Legal schema (matters/court cases). See PRD §18, Module 4 (Matter Management) and Module 5 (Court Case Management).
