...
crm.clientportalusers — object folder for the `ClientPortalUsers` table(s), part of the CRM schema (leads/clients). See PRD §18, Module 2 (Leads) and Module 3 (Clients).
