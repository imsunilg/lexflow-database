...
ops.calendarevents — object folder for the `CalendarEvents` table(s), part of the Ops schema (tasks/calendar/workflow/notifications). See PRD §18, Module 6 (Calendar), Module 10 (Task Management), §23 (Workflow Rules).
