...
fin.invoicetaxes — object folder for the `InvoiceTaxes` table(s), part of the Fin schema (billing/trust/time tracking). See PRD §18, Module 8 (Billing with Trust Accounting) and Module 9 (Time Tracking).
